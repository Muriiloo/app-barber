...
import { createBookig } from "../_actions/create-booking"
...
const ServiceItem = ({ service, barbershop }: ServiceItemProps) => {
  ...
  const handleBokkingOpenSheetChange = () => {
          ...
          <div className="flex-1 space-y-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <Sheet
                ...
                onOpenChange={handleBokkingOpenSheetChange}
              >
                <Button
                  variant="secondary"
                  size="sm"
